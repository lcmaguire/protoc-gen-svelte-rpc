...
type ExampleServiceClient interface {
	CreateExample(context.Context, *connect_go.Request[mocks.Example]) (*connect_go.Response[mocks.Example], error)
	GetExample(context.Context, *connect_go.Request[mocks.GetExampleRequest]) (*connect_go.Response[mocks.Example], error)
}
...
func NewExampleServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ExampleServiceClient {
	...
	return &exampleServiceClient{
		createExample: connect_go.NewClient[mocks.Example, mocks.Example](
			httpClient,
			baseURL+"/tutorial.ExampleService/CreateExample",
			opts...,
		),
		getExample: connect_go.NewClient[mocks.GetExampleRequest, mocks.Example](
			httpClient,
...
type exampleServiceClient struct {
	createExample *connect_go.Client[mocks.Example, mocks.Example]
	getExample    *connect_go.Client[mocks.GetExampleRequest, mocks.Example]
}

// CreateExample calls tutorial.ExampleService.CreateExample.
func (c *exampleServiceClient) CreateExample(ctx context.Context, req *connect_go.Request[mocks.Example]) (*connect_go.Response[mocks.Example], error) {
	return c.createExample.CallUnary(ctx, req)
}

// GetExample calls tutorial.ExampleService.GetExample.
func (c *exampleServiceClient) GetExample(ctx context.Context, req *connect_go.Request[mocks.GetExampleRequest]) (*connect_go.Response[mocks.Example], error) {
...
func (UnimplementedExampleServiceHandler) CreateExample(context.Context, *connect_go.Request[mocks.Example]) (*connect_go.Response[mocks.Example], error) {
...
func (UnimplementedExampleServiceHandler) GetExample(context.Context, *connect_go.Request[mocks.GetExampleRequest]) (*connect_go.Response[mocks.Example], error) {
